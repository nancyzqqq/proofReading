                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="signinServlet" method="post" class="login-form">
                                    ...
                                    <span id = "error" style="color:#fff">${error}</span>
			                        ...
			                        <button type="submit" class="btn" id="login" style="">Sign in</button>
                                    <div class="sepOr">
                                    ...
                                    <button type="button" class="btn" id="signup" style="">Sign up</button>
			                    </form>
		                    </div>
                        </div>
                    </div>
